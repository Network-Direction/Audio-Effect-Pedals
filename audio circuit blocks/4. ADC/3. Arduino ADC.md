...
A register is a very small amount of memory on a CPU or microcontroller. They can be used to store a small piece of information while executing a command, or to apply some setting.
...
| Register | Size  | Name                             |
| -------- | ----- | -------------------------------- |
| TCCR0A   | 8-bit | Timer/Counter Control Register A |
| TCCR0B   | 8-bit | Timer/Counter Control Register B |
| TCNT0    | 8-bit | Timer/Counter                    |
| OCR0A    | 8-bit | Output compare register A        |
| OCR0B    | 8-bit | Output compare register B        |
